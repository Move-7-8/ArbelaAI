...
export async function GET() {
    ...
    try {
        ...
        //TEST
        // let tickers = data.map(stock => stock["ASX_code"]).slice(0, 10); // Use only first 10 tickers
        ...
        ///////////////////
            ...
            return new Response(JSON.stringify({ data: 'File updated successfully' }), { status: 200 });
