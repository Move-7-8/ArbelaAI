...
// function NewsSelect({ company, ticker, industry }) {
...
//               // paddingRight: '4px', // For left chevron
...
//           }}
//         >
//           {['Article 1', 'Article 2', 'Article 3', 'Article 4'].map((articleName, index) => (
//             <div 
//               key={index} 
...
//               <Link
//                 href={{
//                   pathname: `/companies/${companyData.company.toLowerCase().replace(/ /g, '')}/${articleName.toLowerCase().replace(/ /g, '')}`,
//                   query: { company, ticker, industry, article: articleName },
//                 }}
//               >
//                 <div
...
//                   }}
//                 >
//                   <span className="text-gray-500 mb-2">{articleName}</span>
