...
function StockCard({ company }) {
    ...
    const industry = company['get-profile']?.quoteSummary?.result?.length > 0 ? company['get-profile'].quoteSummary.result?.[0]?.summaryProfile?.industry : 'Unknown';
    ...
    console.log('catalog company', company)
