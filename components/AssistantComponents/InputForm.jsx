...
import { SendIcon, LoadingCircle } from "@public/assets/icons/assistant/assistant";
  ...
  return (
    ...
    {/* <div className="fixed bottom-0 flex w-full flex-col items-center space-y-3 bg-gradient-to-b from-transparent via-gray-100 to-gray-100 p-5 pb-3 sm:px-0"> */}
      <form
        ...
        className="relative w-full max-w-custom rounded-xl border border-gray-200 bg-white px-4 pb-2 pt-3 shadow-lg sm:pb-3 sm:pt-4"
        style={{ maxWidth: '90%' }} // Custom width between md and lg
      >
        <Textarea
          ref={inputRef}
          tabIndex={0}
