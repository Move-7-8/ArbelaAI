...
//             const offset = shouldAppend ? tickers.length : 0;
//             const limit = itemPerLoad;
//             const sortbyId = sortBy.id; // Assuming sortBy is always an object with an id
            
//             const apiRoute = searchQuery ? 'api/navCompanies' : 'api/companies';
//             const bodyContent = { limit, offset, searchText: searchQuery, category: selectedCategory, sortbyId };
            
//             console.log("Fetching data with parameters:", { limit, offset, searchText: searchQuery, category: selectedCategory, sortbyId });
...
//             // Since backend already filters companies without names, no need for additional filtering here
//             setTickers(shouldAppend ? prevTickers => [...prevTickers, ...fetchedData] : fetchedData);
