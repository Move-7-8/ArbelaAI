...
export default function Assistant({ companyName, selectedDocuments }) {
  ...
  const [inputmessage, setInputmessage] = useState('Summarise what this company does');
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (assistantId) {
      ...
      console.log('ASSISTANT ID BOUTTA SEND: ', assistantId)

    }
    // ... The rest of your code goes here
    if (threadId) {
    formData_run.append('threadId', threadId);
    console.log('THREAD ID BOUTTA SEND: ', threadId)
    }
    ...
    console.log('userId Line 236:',userId )
    ...
    console.log('line 322 set?',threadId )
    setChatStarted(true);
    // setIsButtonDisabled(false);
